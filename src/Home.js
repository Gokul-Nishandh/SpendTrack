...
const Home = () => {
  ...
  return (
    <main className="home">
        <button className="addexpense" onClick={()=>navigate("/addexpense")}>+ Add expenses</button>
        <div className="functions">
            ...
            <Link to="/viewgroups"><div className="viewgroups"><img alt="pho 5" height="63px" width="63px" src='https://s3-alpha-sig.figma.com/img/c821/76b2/15bea625427df39a2281368d2de03348?Expires=1744588800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=jIdTmwbW1Kb6JlBBo6gd8HM8fxsbPmbnGb39tU75aVCreCrZSK~bS0F4qPDMx-Aw8dOXs8zvsGewo3TD7dm6UDBiRnNv5ChB2xBmxurzwB3pgXfOywcPADtxNWlAVAtljzhdXig0PvMCsorbayul7DKbOKCcLGoltTqlxn91I0df6GkxZIlo0nLYqNK7EA~13GbcefVs1MRhekb4~XhMK6V3Rwf9U8blzE6xPNP1ygV~gskHlTXDhpY~6TEyoLnh2QQvmhVxW4O1ezHcZtv~QWTkqDK3kfW1UCXs9daVzZi90QWCGEbsnSGB6L~N5bv8I7LStRvQMZKC~8TJ1ySQnQ__' /><p>View Groups</p></div></Link>
            <Link to="/trackexpenses"><div className="trackexpense"><img alt="pho 2"height="63px" width="63px" src="https://s3-alpha-sig.figma.com/img/8605/3969/f9123d83984c89969ffcaa8d0966e6a9?Expires=1744588800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=QYhCtPwZDPfiAFe5Ot5~IqDZosG2QgIb3G9OSFe7HcfPONSJsYsTt0nhf04oPnfI76XWe1MBDW2cWbwbnCZuecYb5hZziueRr4yhymf3yWW0uTiubO9aDrWhnLilVVcYJCNA8ELiaRxQp3RC-3KKUY3OpDC7lHAa-6xHx2imCuJGoQI8O4uqFgMip3supV05Rr~QOXNBmelhyyky~PqUDtxFYlIf1EdaUk16FmWlIivtgvMQ9A28YfvVWSqzptX~LHqQwdtd0JlRG3aF1rOPINaGI8G1GOrro70WZf9RhBHa1ueDooy50Nu0YZ6-~na-GXz9a4YFkLr8lY3lNwzSyA__" /><p>Track Expenses</p></div></Link>
            <Link to="/setbudget"><div className="setbudget"><img alt="pho 3"height="63px" width="63px" src="https://s3-alpha-sig.figma.com/img/780a/4415/c035f1d45c069ec9d60377316a50d50b?Expires=1744588800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=ewo5bcLXU1GLVQfTQG2yrsyEfHLvQry~0KyjyD7RmqlSwKqUUwzHtzk7Fn70r7GJbJiO7Wz38t7wiOektBwD1~qBIeU4HU6Sl~GBtlPflt7HfZ8q4ilkTokLWxoKGt9kRVMkuSL71jWvhoAHqUqhE9-dlFjnkcnvoseZOaEj-3KKXaeogl05JHH6knwwspg1uat5NY4yGkWaqUsEqyDCSFYssyYqYjmqC8nZkVATfCc9PnyElp6fWqgfvk8UrlIR-~f2qH9lDlD-J-L~LSuTRhkAl1cw4EpvM2eJJYv3uGdCIZ8~vAutXWTGrixVV13J2OYsUQJk2~prtvQzYp8b-A__" /><p>Set Budget</p></div></Link>
